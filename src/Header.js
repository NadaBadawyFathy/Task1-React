                ...
                <div className="container">
                    ...
                    <div className="navbar-collapse collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto">
                            ...
                            <a href="#skills" className="nav-link active display-inline-block text-decoration-none text-white">Skills</a>
                            <a href="#about" className="nav-link display-inline-block text-decoration-none text-white">About</a>
                            <a href="#projects" className="nav-link display-inline-block text-decoration-none text-white">Projects</a>
